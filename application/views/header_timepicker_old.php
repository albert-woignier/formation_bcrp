...
<html lang="fr">
    <head>
        ...
        <script src="<?php echo base_url(); ?>assets/js/mes_js.js"></script>

        <script src="https://cdn.jsdelivr.net/npm/timepicker@1.13.16/jquery.timepicker.min.js"></script>
        <script src="https://kit.fontawesome.com/af9ba25b12.js" crossorigin="anonymous"></script>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/BCRP_8.ico" />
    </head>
    <body>
        <!---
