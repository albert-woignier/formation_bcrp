    ...
    if (isset($agenda)) :
        ...
        <div class="container agenda">
            ...
            <div class="row container">
                <?php
                $j = array(1 => 'Lun', 2 => 'Mar', 3 => 'Mer', 4 => 'Jeu', 5 => 'Ven', 6 => 'Sam', 0 => 'Dim');
                foreach ($j as $nom_j) :
                    ?>
                    <div class="col jour"><strong><?php echo $nom_j; ?></strong></div>
                <?php endforeach; ?>
            </div>
            ...
            foreach ($agenda as $no_week => $week) :
                ...
                <div class="row week container">
                    ...
                    foreach ($week as $no_jour_week => $jour) :
                        ?>
                        <div class="col jour <?php echo ($no_jour_week == 6 OR $no_jour_week == 7 ) ? "week_end" : "semaine"; ?> container p-2 rounded">
